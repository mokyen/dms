...
inline void runUpdateUntil(MotorControlPid& controller, UpdateCriterion criterion) {
...
inline void runUpdateUntilArrived(MotorControlPid& controller, unsigned long timeoutMs = 10000) {
  unsigned long startMs = millis();
