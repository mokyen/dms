...
inline void cruiseToPosition(MotorControl& controller, EncoderReader& encoder, 
...
inline void pattern_stalker(MotorControl& controller, EncoderReader& encoder) {
...
inline void pattern_pounce(MotorControl& controller, EncoderReader& encoder) {
...
inline void pattern_patrol(MotorControl& controller, EncoderReader& encoder) {
...
inline void pattern_twitch(MotorControl& controller, EncoderReader& encoder) {
...
inline void pattern_lurker(MotorControl& controller, EncoderReader& encoder) {
...
inline void runRandomPattern(MotorControl& controller, EncoderReader& encoder) {
...
inline void hauntingMode(MotorControl& controller, EncoderReader& encoder) {
